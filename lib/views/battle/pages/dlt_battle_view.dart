...
class DltBattleView extends StatefulWidget {
  ///
  ///
  const DltBattleView({super.key});

  @override
  DltBattleViewState createState() => DltBattleViewState();
}

final double cellWidth240 = 240.h;
final double cellWidth220 = 220.h;
...
final double contentWidth = 1420.h;

class DltBattleViewState extends State<DltBattleView> {
  ///顶部左右滑动
  ...
  late DltBattleController controller;

  @override
  Widget build(BuildContext context) {
    return BattleRequestWidget<DltForecastInfo, DltBattleController>(
      title: '大乐透专家PK',
      init: controller,
      rankRoute: AppRoutes.dltBattleRank,
      builder: (controller) {
  ...
  Widget _buildBattleView(DltBattleController controller, int rows) {
    return BattleScrollWidget<DltForecastInfo>(
    ...
    return SingleChildScrollView(
      ...
      child: Row(
        children: [
          ...
          _headerCell('红球20码', cellWidth240),
          _headerCell('红球10码', cellWidth240),
          _headerCell('红球三胆', cellWidth100),
          _headerCell('红球双胆', cellWidth80),
          _headerCell('红球独胆', cellWidth80),
          _headerCell('蓝球杀码', cellWidth100),
          _headerCell('蓝球六码', cellWidth160),
          _headerCell('蓝球双胆', cellWidth80),
          _headerCell('蓝球独胆', cellWidth80),
        ],
      ),
    );
  }
  ...
  Widget _buildBattleDing(DltBattleController controller) {
  ...
  Widget _buildDingMaster(MasterBattle<DltForecastInfo> battle) {
    return Container(
      width: cellHeaderWidth,
      height: cellHeight,
      decoration: BoxDecoration(
      ...
      child: GestureDetector(
        onTap: () {
          Get.toNamed('/dlt/forecast/${battle.master.masterId}');
        },
  ...
  Widget _buildDingContent(DltForecastInfo forecast) {
    return SingleChildScrollView(
      scrollDirection: Axis.horizontal,
      physics: const NeverScrollableScrollPhysics(),
        ...
        child: Row(
          children: [
            ...
            _contentRowCell(forecast.redKill6, cellWidth160,
                bottomBorder: false, color: const Color(0xFFFAFAFA)),
            _contentRowCell(forecast.red20, cellWidth240,
                bottomBorder: false, color: const Color(0xFFFAFAFA)),
            _contentRowCell(forecast.red10, cellWidth240,
                bottomBorder: false, color: const Color(0xFFFAFAFA)),
            ...
            _contentRowCell(forecast.red1, cellWidth80,
                bottomBorder: false, color: const Color(0xFFFAFAFA)),
            _contentRowCell(forecast.blueKill3, cellWidth100,
                bottomBorder: false, color: const Color(0xFFFAFAFA)),
            _contentRowCell(forecast.blue6, cellWidth160,
                bottomBorder: false, color: const Color(0xFFFAFAFA)),
            _contentRowCell(forecast.blue2, cellWidth80,
                bottomBorder: false, color: const Color(0xFFFAFAFA)),
            _contentRowCell(forecast.blue1, cellWidth80,
                bottomBorder: false, color: const Color(0xFFFAFAFA)),
          ],
        ),
      ),
  ...
  Widget _buildBattleContent(DltBattleController controller, int rows) {
    return SizedBox(
  ...
  Widget _buildLeftContent(DltBattleController controller) {
    return SingleChildScrollView(
  ...
  Widget _buildBodyContent(DltBattleController controller) {
    return SingleChildScrollView(
      scrollDirection: Axis.horizontal,
      physics: const NeverScrollableScrollPhysics(),
      ...
      child: SizedBox(
        ...
        child: ListView.builder(
          ...
          itemBuilder: (context, index) {
            DltForecastInfo forecast = controller.battles[index].forecast;
            Color color =
  ...
  Widget _bodyContentRow(DltForecastInfo forecast, Color color) {
    return SizedBox(
      height: cellHeight,
      width: Get.width - cellHeaderWidth,
      child: SingleChildScrollView(
        ...
        child: Row(
          children: [
            ...
            _contentRowCell(forecast.red20, cellWidth240, color: color),
            _contentRowCell(forecast.red10, cellWidth240, color: color),
            ...
            _contentRowCell(forecast.blueKill3, cellWidth100, color: color),
            _contentRowCell(forecast.blue6, cellWidth160, color: color),
            _contentRowCell(forecast.blue2, cellWidth80, color: color),
            _contentRowCell(forecast.blue1, cellWidth80, color: color),
          ],
        ),
      ),
    );
  ...
  Widget _buildMaster(MasterBattle<DltForecastInfo> battle) {
    return Container(
      width: cellHeaderWidth,
      height: cellHeight,
      decoration: BoxDecoration(
  ...
  Widget _buildBattleBottom(DltBattleController controller) {
    return Row(
      children: [
  ...
  Widget _buildLeftBottom(DltBattleController controller) {
    return Container(
      width: cellHeaderWidth,
      height: cellHeight,
      decoration: BoxDecoration(
  ...
  Widget _buildBottomContent(DltBattleController controller) {
    Future.delayed(const Duration(milliseconds: 50),
      ...
      child: SizedBox(
        ...
        child: Row(
          children: [
            ...
            _bottomContentCell(
                width: cellWidth240, views: controller.views((e) => e.red20)),
            _bottomContentCell(
                width: cellWidth240, views: controller.views((e) => e.red10)),
            _bottomContentCell(
            ...
            _bottomContentCell(
                width: cellWidth100, views: controller.views((e) => e.bk)),
            _bottomContentCell(
                width: cellWidth160, views: controller.views((e) => e.blue6)),
            _bottomContentCell(
                width: cellWidth80, views: controller.views((e) => e.blue2)),
            _bottomContentCell(
                width: cellWidth80, views: controller.views((e) => e.blue1)),
          ],
        ),
      ),
    );
  ...
  void initState() {
    ...
    super.initState();
    controller = DltBattleController();
