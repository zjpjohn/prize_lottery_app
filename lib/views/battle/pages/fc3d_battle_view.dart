...
class Fc3dBattleView extends StatefulWidget {
  ///
  ///
  const Fc3dBattleView({super.key});

  @override
  Fc3dBattleViewState createState() => Fc3dBattleViewState();
}
...
class Fc3dBattleViewState extends State<Fc3dBattleView> {
  ///顶部左右滑动
  ...
  late Fc3dBattleController controller;

  @override
  Widget build(BuildContext context) {
    return BattleRequestWidget<Fc3dForecastInfo, Fc3dBattleController>(
      title: '福彩3D专家PK',
      init: controller,
      rankRoute: AppRoutes.fc3dBattleRank,
      builder: (controller) {
  ...
  Widget _buildBattleView(Fc3dBattleController controller, int rows) {
  ...
  Widget _buildBattleContent(Fc3dBattleController controller, int rows) {
    return SizedBox(
  ...
  Widget _buildBattleDing(Fc3dBattleController controller) {
  ...
  Widget _buildDingContent(Fc3dForecastInfo forecast) {
  ...
  Widget _buildBattleBottom(Fc3dBattleController controller) {
    return Row(
      children: [
  ...
  Widget _buildLeftBottom(Fc3dBattleController controller) {
    return Container(
  ...
  Widget _buildBottomContent(Fc3dBattleController controller) {
  ...
  Widget _buildLeftContent(Fc3dBattleController controller) {
    return SingleChildScrollView(
  ...
  Widget _buildDingMaster(MasterBattle<Fc3dForecastInfo> battle) {
    return Container(
      width: cellHeaderWidth,
      height: dingHeight,
      decoration: BoxDecoration(
      ...
      child: GestureDetector(
        onTap: () {
          Get.toNamed('/fc3d/forecast/${battle.master.masterId}');
        },
        behavior: HitTestBehavior.opaque,
        child: Row(
          mainAxisAlignment: MainAxisAlignment.center,
  ...
  Widget _buildMaster(MasterBattle<Fc3dForecastInfo> battle) {
    return Container(
      width: cellHeaderWidth,
      height: cellHeight,
      decoration: BoxDecoration(
  ...
  Widget _buildBodyContent(Fc3dBattleController controller) {
    return SingleChildScrollView(
      scrollDirection: Axis.horizontal,
      physics: const NeverScrollableScrollPhysics(),
      ...
      child: SizedBox(
        ...
        child: ListView.builder(
          ...
          itemBuilder: (context, index) {
            Fc3dForecastInfo forecast = controller.battles[index].forecast;
            Color color =
  ...
  Widget _bodyContentRow(Fc3dForecastInfo forecast, Color color) {
    return SizedBox(
      height: cellHeight,
  ...
  void initState() {
    ...
    super.initState();
    controller = Fc3dBattleController();
