...
class Pl3BattleRankView extends StatelessWidget {
  ///
  const Pl3BattleRankView({super.key});
  ...
  Widget build(BuildContext context) {
    return LayoutContainer(
      ...
      content: RefreshWidget<Pl3BattleMasterController>(
        init: Pl3BattleMasterController(),
        builder: (controller) {
  ...
  Widget _buildBattleMaster(
      Pl3BattleMasterController controller, int index, bool border) {
    MasterBattleRank<Pl3MasterMulRank> rank = controller.ranks[index];
