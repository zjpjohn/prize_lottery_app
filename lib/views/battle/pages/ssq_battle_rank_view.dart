...
class SsqBattleRankView extends StatelessWidget {
  ///
  ///
  const SsqBattleRankView({super.key});
  ...
  Widget build(BuildContext context) {
    return LayoutContainer(
      ...
      content: RefreshWidget<SsqBattleMasterController>(
        init: SsqBattleMasterController(),
        builder: (controller) {
  ...
  Widget _buildBattleMaster(
    SsqBattleMasterController controller,
    int index,
    bool border,
  ) {
    MasterBattleRank<SsqMasterMulRank> rank = controller.ranks[index];
    return BattleRankEntryWidget(
      ...
      data: MulMasterRank(
        ...
        achieves: [
          AchieveInfo(name: '围红', count: rank.masterRank.red25.count),
          AchieveInfo(name: '杀红', count: rank.masterRank.rk3.count),
          AchieveInfo(
              name: '杀蓝',
