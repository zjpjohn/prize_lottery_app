...
class BattleRankEntryWidget extends StatelessWidget {
  ///
  const BattleRankEntryWidget({
    super.key,
    this.border = true,
    this.browsed = false,
    this.battled = false,
            ...
            children: [
              Container(
                ...
                decoration: BoxDecoration(
                  color: battled ? const Color(0xFFFAFAFA) : Colors.white,
                  border: Border(
                    bottom: border
                        ? BorderSide(
                            width: 0.3.w,
                      ...
                      Expanded(
                        child: SizedBox(
                          ...
                          child: Column(
                            ...
                            children: <Widget>[
                              Text(
                                Tools.limitName(data.rank.master.name, 12),
                                style: TextStyle(
