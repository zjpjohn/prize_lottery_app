...
class Fc3dHotCensusView extends StatelessWidget {
  ///
  ///
  const Fc3dHotCensusView({super.key});
  ...
  Widget build(BuildContext context) {
    return LayoutContainer(
      ...
      content: Container(
          ...
          child: FeeCensusRequestWidget<Fc3dHotCensusController>(
            title: '查看最新推荐热门专家分析',
            adsName: '热门专家分析',
  ...
  Widget _buildTitleHeader(Fc3dHotCensusController controller) {
    return Container(
  ...
  Widget _buildDescription() {
    return Container(
      ...
      child: Text(
        '福彩3D热点分析通过对推荐预测排名“最近10期至少连续5期排名前150的热门专家”本期推荐方案'
        '进行分指标汇总计算分析，计算出本期热门专家推荐在不同指标维度下号码推荐热度和杀码热度趋势。'
        '热门专家统计趋势每天下午16:20开始更新当期统计，并且每小时更新一次直到到19点结束。',
        style: TextStyle(
          fontSize: 15.sp,
          height: 1.3,
          color: Colors.black,
  ...
  Widget _buildTrendChart(Fc3dHotCensusController controller) {
    List<Widget> items = [];
  ...
  Widget _buildNoticeView() {
    return Container(
      ...
      child: Column(
        ...
        children: <Widget>[
          Text(
            '1、热门趋势分析指标主要包含：三胆、五码、六码、七码、杀一码、杀二码等，并进行选号热度统计分析。',
            style: TextStyle(
              fontSize: 12.sp,
              color: Colors.black45,
            ),
          ...
          Text(
            '3、关于热门趋势分析指标使用，需要您在使用过程中结合自己的经验多观察、多总结，相信一定能为您带来意想不到的收获。',
            style: TextStyle(
              fontSize: 12.sp,
              color: Colors.black45,
            ),
