...
class Fc3dRateCensusView extends StatelessWidget {
  ///
  ///
  const Fc3dRateCensusView({super.key});
  ...
  Widget build(BuildContext context) {
    return LayoutContainer(
      ...
      content: Container(
          ...
          child: FeeCensusRequestWidget<Fc3dRateCensusController>(
  ...
  Widget _buildTitleHeader(Fc3dRateCensusController controller) {
    return Container(
  ...
  Widget _buildDescription() {
    return Container(
      ...
      child: Text(
        '福彩3D牛人汇总通过对“最近15、30期推荐综合命中率最高的牛人专家”本期推荐方案'
  ...
  Widget _buildTrendChart(Fc3dRateCensusController controller) {
    List<Widget> items = [];
