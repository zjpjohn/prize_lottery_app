...
class Pl3HotCensusView extends StatelessWidget {
  ///
  ///
  const Pl3HotCensusView({super.key});
  ...
  Widget build(BuildContext context) {
    return LayoutContainer(
      ...
      content: Container(
          ...
          child: FeeCensusRequestWidget<Pl3HotCensusController>(
            title: '查看最新推荐热门专家分析',
            adsName: '热门专家分析',
  ...
  Widget _buildTitleHeader(Pl3HotCensusController controller) {
    return Container(
  ...
  Widget _buildDescription() {
    return Container(
      ...
      child: Text(
        '排列三热点分析通过对推荐预测排名“最近10期至少连续5期排名前150的热门专家”本期推荐方案'
  ...
  Widget _buildTrendChart(Pl3HotCensusController controller) {
    List<Widget> items = [];
