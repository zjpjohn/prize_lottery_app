...
class QlcFullCensusView extends StatelessWidget {
  ///
  ///
  const QlcFullCensusView({super.key});
  ...
  Widget build(BuildContext context) {
    return LayoutContainer(
      ...
      content: Container(
        ...
        child: FeeCensusRequestWidget<QlcFullCensusController>(
          title: '查看七乐彩整体趋势分析',
          adsName: '整体预测分析',
  ...
  Widget _buildTitleHeader(QlcFullCensusController controller) {
    return Container(
  ...
  Widget _buildDescription() {
    return Container(
      ...
      child: Text(
        '七乐彩整体分析通过对上一期推荐综合排名前100、200、400、600、800以及1000的专家'
  ...
  Widget _buildLevelFilter(QlcFullCensusController controller) {
  ...
  Widget _buildTrendChart(QlcFullCensusController controller) {
    List<Widget> items = [];
  ...
  Widget _buildNoticeView() {
    return Container(
      ...
      child: Column(
        ...
        children: <Widget>[
          Text(
            '1、整体趋势分析指标包含三胆、12码、18码、22码、杀三码、杀六码等，并进行选号热度统计分析。',
            style: TextStyle(
              fontSize: 12.sp,
              color: Colors.black45,
            ),
