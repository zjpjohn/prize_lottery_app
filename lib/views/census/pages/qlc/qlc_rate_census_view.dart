...
class QlcRateCensusView extends StatelessWidget {
  ///
  ///
  const QlcRateCensusView({super.key});
  ...
  Widget build(BuildContext context) {
    return LayoutContainer(
      ...
      content: Container(
        ...
        child: FeeCensusRequestWidget<QlcRateCensusController>(
          title: '查看七乐彩牛人预测汇总分析',
          adsName: '牛人汇总分析',
  ...
  Widget _buildDescription() {
    return Container(
      ...
      child: Text(
        '七乐彩牛人汇总通过对“最近15、30期推荐综合命中率最高的牛人专家”本期推荐方案'
  ...
  Widget _buildTrendChart(QlcRateCensusController controller) {
    List<Widget> items = [];
  ...
  Widget _buildTitleHeader(QlcRateCensusController controller) {
    return Container(
  ...
  Widget _buildNoticeView() {
    return Container(
      ...
      child: Column(
        ...
        children: <Widget>[
          Text(
            '1、牛人趋势分析指标包含三胆、12码、18码、22码、杀三码、杀六码等，并进行选号热度统计分析。',
            style: TextStyle(
              fontSize: 12.sp,
              color: Colors.black45,
            ),
