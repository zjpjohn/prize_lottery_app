...
class SsqFullCensusView extends StatelessWidget {
  ///
  ///
  const SsqFullCensusView({super.key});
  ...
  Widget build(BuildContext context) {
    return LayoutContainer(
      ...
      content: Container(
        ...
        child: FeeCensusRequestWidget<SsqFullCensusController>(
          title: '查看双色球整体趋势分析',
          adsName: '整体预测分析',
  ...
  Widget _buildTitleHeader(SsqFullCensusController controller) {
    return Container(
  ...
  Widget _buildDescription() {
    return Container(
      ...
      child: Text(
        '双色球整体分析通过对上一期推荐综合排名前100、200、400、600、800以及1000的专家'
  ...
  Widget _buildLevelFilter(SsqFullCensusController controller) {
  ...
  Widget _buildRedTrendChart(SsqFullCensusController controller) {
    List<Widget> items = [];
  ...
  Widget _buildBlueTrendChart(SsqFullCensusController controller) {
    List<Widget> items = [];
  ...
  Widget _buildNoticeView() {
    return Container(
      ...
      child: Column(
        ...
        children: <Widget>[
          Text(
            '1、整体趋势指标包含三胆、12码、20码、25码、杀三码、杀六码、蓝球三码、蓝球五码以及蓝球杀码等，并进行选号热度统计分析。',
            style: TextStyle(
              fontSize: 12.sp,
              color: Colors.black45,
            ),
          ...
          Text(
            '3、关于整体趋势分析指标使用，需要您在使用过程中多观察、多总结，相信一定能为您带来意想不到的收获。',
            style: TextStyle(
              fontSize: 12.sp,
              color: Colors.black45,
            ),
