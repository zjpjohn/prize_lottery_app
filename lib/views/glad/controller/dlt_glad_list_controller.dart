...
class DltGladListController extends AbsPageQueryController {
  ///
  List<DltMasterGlad> glads = [];

  ///
  List<DltMasterMulRank> recommends = [];
  ...
  Future<void> onInitial() async {
    ...
    ///
    Future<void> gladAsync = MasterGladRepository.dltGladList(
      page: page,
      limit: limit,
    ).then((value) {
      total = value.total;
    ...
    Future<void> recAsync =
        LottoMasterRepository.dltRandomMasters().then((value) {
      recommends
        ..clear()
        ..addAll(value);
    });
  ...
  Future<void> onLoadMore() async {
    ...
    ///
    await MasterGladRepository.dltGladList(
      page: page,
      limit: limit,
    ).then((value) {
      total = value.total;
