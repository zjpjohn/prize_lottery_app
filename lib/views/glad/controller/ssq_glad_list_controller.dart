...
class SsqGladListController extends AbsPageQueryController {
  ///
  List<SsqMasterGlad> glads = [];

  ///
  List<SsqMasterMulRank> recommends = [];
  ...
  Future<void> onInitial() async {
    ...
    Future<void> recAsync =
        LottoMasterRepository.ssqRandomMasters().then((value) {
      recommends
        ..clear()
        ..addAll(value);
    });
    ...
    ///
    Future.wait([gladAsync, recAsync]).then((value) {
  ...
  Future<void> onLoadMore() async {
    ...
    ///
    await MasterGladRepository.ssqGladList(
      page: page,
      limit: limit,
    ).then((value) {
      total = value.total;
