...
class DltCalculatorView extends StatelessWidget {
  ///
  ///
  const DltCalculatorView({super.key});
  ...
  Widget build(BuildContext context) {
    return LayoutContainer(
      ...
      content: Container(
        color: Colors.white,
        child: RequestWidget<DltCalculatorController>(
          builder: (controller) {
  ...
  Widget _buildCalcView(DltCalculatorController controller) {
    return Container(
      margin: EdgeInsets.only(bottom: 12.w),
  ...
  Widget _buildPickerView(DltCalculatorController controller) {
  ...
  Widget _showPickerPanel() {
    return GetBuilder<DltCalculatorController>(
      builder: (controller) {
  ...
  Widget _buildHitView(DltCalculatorController controller) {
    return GestureDetector(
      onTap: () {
        showModalBottomSheet(
            context: Get.context!,
  ...
  Widget _showHitPanel() {
    return GetBuilder<DltCalculatorController>(builder: (controller) {
      return ModalSheetView(
        title: '我的命中',
        height: Get.height * 9 / 16,
        child: Container(
  ...
  Widget _buildCalcBtn(DltCalculatorController controller) {
    return Container(
  ...
  Widget _buildAwardCounter(DltCalculatorController controller) {
