...
class DltRedTrendView extends StatefulWidget {
  ///
  ///
  const DltRedTrendView({
    super.key,
    required this.rows,
    required this.omits,
  ...
  @override
  DltRedTrendViewState createState() => DltRedTrendViewState();
}

class DltRedTrendViewState extends State<DltRedTrendView>
      ...
      (index) => Container(
        ...
        decoration: BoxDecoration(
          ...
          border: Border(
            ...
            bottom: BorderSide(color: greyBorder, width: 0.4),
            right: BorderSide(
              color: index == 17 ? redFont : greyBorder,
              width: index == 17 ? 1 : 0.4,
            ),
          ),
        ),
        child: Text(
        ...
        .map(
          (e) => Container(
            ...
            decoration: BoxDecoration(
              border: Border(
                right: BorderSide(
                  color: e.key == '18' ? redFont : greyBorder,
                  width: e.key == '18' ? 1 : 0.4,
                ),
                bottom: BorderSide(color: greyBorder, width: 0.4),
              ),
            ),
