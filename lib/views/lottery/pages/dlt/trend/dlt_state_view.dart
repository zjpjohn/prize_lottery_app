...
class DltStateView extends StatefulWidget {
  ///
  ///
  const DltStateView({
    super.key,
  ...
  @override
  DltStateViewState createState() => DltStateViewState();
}

class DltStateViewState extends State<DltStateView>
  ...
  List<CensusCell> cells = [
    CensusCell(title: '开奖号码', width: 120.w, height: trendLeftWidth),
    CensusCell(title: '和值', width: 38.w, height: trendLeftWidth),
    CensusCell(title: '跨度', width: 38.w, height: trendLeftWidth),
    CensusCell(title: '大小形态', width: 100.w, height: trendLeftWidth),
    CensusCell(title: '大小比', width: 66.w, height: trendLeftWidth),
    CensusCell(title: '奇偶形态', width: 100.w, height: trendLeftWidth),
    CensusCell(title: '奇偶比', width: 66.w, height: trendLeftWidth),
    CensusCell(title: '质合形态', width: 100.w, height: trendLeftWidth),
    CensusCell(title: '质合比', width: 66.w, height: trendLeftWidth),
  ];
