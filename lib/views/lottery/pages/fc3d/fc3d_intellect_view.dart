...
class Fc3dIntellectView extends StatelessWidget {
  const Fc3dIntellectView({super.key});

  @override
  Widget build(BuildContext context) {
    return ShareRequestWidget<Fc3dIntellectController>(
        title: '智能选号',
        share: (controller) {
  ...
  void _sharePoster(Fc3dIntellectController controller) {
  ...
  Widget _buildPeriodHeader(
      Fc3dIntellectController controller, bool tapEnable) {
    return Container(
      color: Colors.white,
  ...
  Widget _buildIndexContent(Fc3dIntellectController controller) {
  ...
  Widget _buildAuthedDing({
    required Fc3dIntellectController controller,
                        ...
                        GestureDetector(
                          ...
                          child: Stack(
                            children: [
                              ...
                              if (picked.contains(e.ball) && e.ball == lotto)
                                Positioned(
                                  bottom: 1.h,
                                  left: 13.h,
                                  child: Icon(
  ...
  Widget _buildPickBottom(Fc3dIntellectController controller) {
    return controller.feeRequired
        ? _buildMemberHint()
        : _buildSavePick(controller);
  }

  Widget _buildSavePick(Fc3dIntellectController controller) {
    return Container(
      height: 55.h,
      width: Get.width,
      decoration: BoxDecoration(
