...
class Fc3dItemTrendView extends StatefulWidget {
  const Fc3dItemTrendView({super.key});

  @override
  State<Fc3dItemTrendView> createState() => _Fc3dItemTrendViewState();
}

class _Fc3dItemTrendViewState extends State<Fc3dItemTrendView>
  ...
  Widget build(BuildContext context) {
    ...
    Get.put(LotteryItemOmitController('fc3d'));
