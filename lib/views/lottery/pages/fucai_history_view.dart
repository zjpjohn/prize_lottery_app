...
class FucaiHistoryView extends StatefulWidget {
  const FucaiHistoryView({super.key});

  @override
  State<FucaiHistoryView> createState() => _FucaiHistoryViewState();
}

class _FucaiHistoryViewState extends State<FucaiHistoryView> {
  ///
  ///
  ...
  void initState() {
    ...
    _controller = WebViewController()
      ...
      ..loadRequest(Uri.parse(OpenVideoUtils.fucaiHistoryUri))
