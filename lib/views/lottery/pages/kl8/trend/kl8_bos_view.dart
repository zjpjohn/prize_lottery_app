...
class Kl8BosView extends StatefulWidget {
  const Kl8BosView({
    super.key,
    required this.rows,
    required this.omits,
  ...
  @override
  State<Kl8BosView> createState() => _Kl8BosViewState();
}

class _Kl8BosViewState extends State<Kl8BosView>
      ...
      (index) => Container(
        ...
        decoration: BoxDecoration(
          ...
          border: Border(
            ...
            bottom: BorderSide(color: greyBorder, width: 0.4),
            right: BorderSide(
              color: index == 5 || index == 14 ? redFont : greyBorder,
              width: index == 5 || index == 14 ? 1 : 0.4,
            ),
          ),
        ),
        child: Text(
  ...
  Widget bodyRow(Kl8Omit omit) {
    return SingleChildScrollView(
      ...
      scrollDirection: Axis.horizontal,
      child: Row(
        children: _buildBodyCells(omit.bsOmit.values),
      ),
    );
  }
          ...
          (e) => Container(
            ...
            decoration: BoxDecoration(
              border: Border(
                bottom: BorderSide(color: greyBorder, width: 0.4),
                right: BorderSide(
                  width: e.key == '5:15' || e.key == '14:6' ? 1 : 0.4,
                  color:
                      e.key == '5:15' || e.key == '14:6' ? redFont : greyBorder,
                ),
              ),
            ),
            child: e.value == 0
    ...
    return SizedBox(
      ...
      child: SingleChildScrollView(
        ...
        child: SizedBox(
          ...
          child: Column(
            children: [
              _buildCensusRow(census.bsMax),
              _buildCensusRow(census.bsAvg),
              _buildCensusRow(census.bsFreq),
              _buildCensusRow(census.bsSeries),
            ],
          ),
        ),
      ),
    ...
    return SingleChildScrollView(
      ...
      child: Row(
        children: census
            .map((e) => _censusCell(
                  value: e.value,
                  border: e.key == '5:15' || e.key == '14:6' ? 1 : 0.4,
                  color:
                      e.key == '5:15' || e.key == '14:6' ? redFont : greyBorder,
                ))
            .toList(),
