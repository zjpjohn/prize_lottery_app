...
class Kl8KuaView extends StatefulWidget {
  const Kl8KuaView({
    super.key,
    required this.rows,
    required this.omits,
  ...
  @override
  State<Kl8KuaView> createState() => _Kl8KuaViewState();
}

final List<String> kuaHeaders = [
  '19+',
  '39+',
  '53+',
  '62+',
...
class _Kl8KuaViewState extends State<Kl8KuaView>
      ...
      (index) => Container(
        ...
        decoration: BoxDecoration(
          ...
          border: Border(
            ...
            bottom: BorderSide(color: greyBorder, width: 0.4),
            right: BorderSide(
              color: index == 2 || index == 10 ? redFont : greyBorder,
              width: index == 2 || index == 10 ? 1 : 0.4,
            ),
          ),
        ),
        child: Text(
  ...
  Widget bodyRow(Kl8Omit omit) {
    return SingleChildScrollView(
      ...
      scrollDirection: Axis.horizontal,
      child: Row(
        children: _buildBodyCells(omit.kuaOmit.values),
      ),
    );
  }
          ...
          (e) => Container(
            ...
            decoration: BoxDecoration(
              border: Border(
                bottom: BorderSide(color: greyBorder, width: 0.4),
                right: BorderSide(
                  width: e.key == '53+' || e.key == '76' ? 1 : 0.4,
                  color: e.key == '53+' || e.key == '76' ? redFont : greyBorder,
                ),
              ),
            ),
            child: e.value == 0
    ...
    return SizedBox(
      ...
      child: SingleChildScrollView(
        ...
        child: SizedBox(
          ...
          child: Column(
            children: [
              _buildCensusRow(census.kuaMax),
              _buildCensusRow(census.kuaAvg),
              _buildCensusRow(census.kuaFreq),
              _buildCensusRow(census.kuaSeries),
            ],
          ),
        ),
      ),
    ...
    return SingleChildScrollView(
      ...
      child: Row(
        children: census
            .map((e) => _censusCell(
                  value: e.value,
                  border: e.key == '53+' || e.key == '76' ? 1 : 0.4,
                  color: e.key == '53+' || e.key == '76' ? redFont : greyBorder,
                ))
            .toList(),
      ),
