...
class Kl8TrendView extends StatefulWidget {
  const Kl8TrendView({
    super.key,
    required this.rows,
    required this.omits,
  ...
  @override
  State<Kl8TrendView> createState() => _Kl8TrendViewState();
}

class _Kl8TrendViewState extends State<Kl8TrendView>
      ...
      (index) => Container(
        ...
        decoration: BoxDecoration(
          ...
          border: Border(
            ...
            bottom: BorderSide(color: greyBorder, width: 0.4),
            right: BorderSide(
              color: index % 8 == 7 && index < 79 ? redFont : greyBorder,
              width: index % 8 == 7 && index < 79 ? 1 : 0.4,
            ),
          ),
        ),
        child: Text(
  ...
  Widget bodyRow(Kl8Omit omit) {
    return SingleChildScrollView(
      ...
      scrollDirection: Axis.horizontal,
      child: Row(
        children: _buildBodyCells(omit.ballOmit.values),
      ),
    );
  }
        ...
        .map(
          (e) => Container(
            ...
            decoration: BoxDecoration(
              ...
              bottom: BorderSide(color: greyBorder, width: 0.4),
              right: BorderSide(
                color: int.parse(e.key) % 8 == 0 && int.parse(e.key) < 80
                    ? redFont
                    : greyBorder,
                width: int.parse(e.key) % 8 == 0 && int.parse(e.key) < 80
                    ? 1
                    : 0.4,
              ),
            )),
    ...
    return SizedBox(
      ...
      child: SingleChildScrollView(
        ...
        child: SizedBox(
          ...
          child: Column(
            children: [
              _buildCensusRow(census.ballMax),
              _buildCensusRow(census.ballAvg),
              _buildCensusRow(census.ballFreq),
              _buildCensusRow(census.ballSeries),
            ],
          ),
        ),
      ),
