...
class Pl3NumberTrendView extends StatefulWidget {
  ///
  const Pl3NumberTrendView({super.key});

  @override
  Pl3NumberTrendViewState createState() => Pl3NumberTrendViewState();
}

class Pl3NumberTrendViewState extends State<Pl3NumberTrendView>
  ...
  Widget build(BuildContext context) {
    ...
    return LayoutContainer(
      ...
      right: GestureDetector(
        onTap: () {
          Get.toNamed(AppRoutes.pl3ItemOmit);
        },
  ...
  Widget _buildTabView(double height, int rows) {
    return SizedBox(
      ...
      child: TabBarView(
        ...
        children: [
          Num3TrendView(rows: rows, type: 'pl3'),
          Num3StateView(rows: rows, type: 'pl3'),
          Num3SumView(rows: rows, type: 'pl3'),
          Num3KuaView(rows: rows, type: 'pl3'),
          Num3ShapeView(rows: rows, type: 'pl3'),
          Num3MatchView(rows: rows, type: 'pl3'),
          Num3OttView(rows: rows, type: 'pl3'),
        ],
      ),
    );
  }
