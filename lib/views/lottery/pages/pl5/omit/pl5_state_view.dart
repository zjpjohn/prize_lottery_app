...
class Pl5StateView extends StatefulWidget {
  const Pl5StateView({
    super.key,
    required this.rows,
  });
  ...
  @override
  State<Pl5StateView> createState() => _Pl5StateViewState();
}

class _Pl5StateViewState extends State<Pl5StateView>
    with AutomaticKeepAliveClientMixin {
  @override
  Widget build(BuildContext context) {
    super.build(context);
    Get.put(LotteryStateController('pl5'));
    return Column(
      children: [
        SizedBox(
...
class StateViewState extends State<StateView> {
  ...
  List<CensusCell> cells = [
    ...
    CensusCell(title: '奖号形态', width: 100.w, height: trendCellSize),
  ...
  Widget _bodyRow(LotteryCensus census) {
    ...
    views.add(
      _buildRowCell(
        child: Text(
          LotteryUtils.p5Pattern(census.intBalls),
          style: TextStyle(
            color: blackFont,
            fontSize: 13.sp,
          ),
