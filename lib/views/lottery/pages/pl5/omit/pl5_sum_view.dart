...
class Pl5SumView extends StatefulWidget {
  const Pl5SumView({
    super.key,
    required this.rows,
  });
  ...
  @override
  State<Pl5SumView> createState() => _Pl5SumViewState();
}

class _Pl5SumViewState extends State<Pl5SumView>
  ...
  Widget build(BuildContext context) {
    super.build(context);
    Get.put(LotterySumOmitController('pl5'));
    return Column(
      children: [
        SizedBox(
          height: widget.rows * trendCellSize + 0.5.w,
          child: RequestWidget<LotterySumOmitController>(
            init: LotterySumOmitController('pl5'),
            builder: (controller) {
              return SumOmitView(
                rows: widget.rows,
                headers: controller.sumHeaders,
      ...
      child: SingleChildScrollView(
        ...
        child: SizedBox(
          ...
          child: CustomPaint(
            ...
            foregroundPainter: RecDrawLinePainter(buildPl5SumPositions(omits)),
            child: Column(
