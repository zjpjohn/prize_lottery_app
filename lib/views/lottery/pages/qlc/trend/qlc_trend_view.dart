...
class QlcTrendView extends StatefulWidget {
  ///
  const QlcTrendView({
    super.key,
    required this.rows,
  ...
  final QlcOmitCensus census;

  @override
  QlcTrendViewState createState() => QlcTrendViewState();
}

class QlcTrendViewState extends State<QlcTrendView>
      ...
      (index) => Container(
        ...
        decoration: BoxDecoration(
          ...
          border: Border(
            ...
            bottom: BorderSide(color: greyBorder, width: 0.4),
            right: BorderSide(
              color: index == 14 ? redFont : greyBorder,
              width: index == 14 ? 1 : 0.4,
            ),
          ),
        ),
        child: Text(
        ...
        .map(
          (e) => Container(
            ...
            decoration: BoxDecoration(
              border: Border(
                right: BorderSide(
                  color: e.key == '15' ? redFont : greyBorder,
                  width: e.key == '15' ? 1 : 0.4,
                ),
                bottom: BorderSide(color: greyBorder, width: 0.4),
              ),
            ),
  ...
  Widget _bottomBodyContent(QlcOmitCensus census) {
    return SizedBox(
      width: MediaQuery.of(context).size.width - left,
