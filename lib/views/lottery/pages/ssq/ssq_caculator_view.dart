...
class SsqCalculatorView extends StatelessWidget {
  ///
  ///
  const SsqCalculatorView({super.key});
  ...
  Widget build(BuildContext context) {
    return LayoutContainer(
      ...
      content: Container(
        color: Colors.white,
        child: RequestWidget<SsqCalculatorController>(
          builder: (controller) {
  ...
  Widget _buildCalcView(SsqCalculatorController controller) {
    return Container(
      margin: EdgeInsets.only(bottom: 12.w),
  ...
  Widget _buildPickerView(SsqCalculatorController controller) {
  ...
  Widget _showPickerPanel() {
    return GetBuilder<SsqCalculatorController>(
      builder: (controller) {
                        ...
                        child: Wrap(
                          ...
                          children: List.generate(16, (index) {
                            ...
                            return RadioButton(
                              ...
                              selected: controller.pBlue == e,
                              handle: (value) {
                                controller.pBlue = int.parse(value);
                              },
                            );
                          }),
                        ),
  ...
  Widget _buildHitView(SsqCalculatorController controller) {
    return GestureDetector(
      onTap: () {
        showModalBottomSheet(
            context: Get.context!,
  ...
  Widget _showHitPanel() {
    return GetBuilder<SsqCalculatorController>(builder: (controller) {
      return ModalSheetView(
        title: '我的命中',
        height: Get.height * 9 / 16,
        child: Container(
  ...
  Widget _buildCalcBtn(SsqCalculatorController controller) {
    return Container(
      margin: EdgeInsets.only(top: 10.w, bottom: 16.w),
      child: GestureDetector(
        onTap: () {
          controller.calcCounters();
        },
        child: Container(
          width: 200.w,
          height: 34.w,
  ...
  Widget _buildAwardCounter(SsqCalculatorController controller) {
    ...
    return Container(
      ...
      child: Row(
        children: [
          ...
          _buildCounterCell(
            title:
                '${counter.level.idx <= 2 ? '${levelAwards[counter.level.idx]}浮动' : counter.level.award}',
            width: 72.w,
            right: true,
            color: color,
            bottom: !radius,
