...
class SsqBlueTrendView extends StatefulWidget {
  ///
  ///
  const SsqBlueTrendView({
    super.key,
    required this.rows,
    required this.omits,
  ...
  @override
  SsqBlueTrendViewState createState() => SsqBlueTrendViewState();
}

class SsqBlueTrendViewState extends State<SsqBlueTrendView>
      ...
      (index) => Container(
        ...
        decoration: BoxDecoration(
          ...
          border: Border(
            ...
            bottom: BorderSide(color: greyBorder, width: 0.4),
            right: BorderSide(
              color: index == 7 ? blueFont : greyBorder,
              width: index == 7 ? 1 : 0.4,
            ),
          ),
        ),
        ...
        .map(
          (e) => Container(
            ...
            decoration: BoxDecoration(
              border: Border(
                right: BorderSide(
                  color: e.key == '08' ? blueFont : greyBorder,
                  width: e.key == '08' ? 1 : 0.4,
                ),
                bottom: BorderSide(color: greyBorder, width: 0.4),
              ),
            ),
