...
class SsqStateView extends StatefulWidget {
  ///
  const SsqStateView({
    super.key,
    required this.rows,
  ...
  @override
  SsqStateViewState createState() => SsqStateViewState();
}

class SsqStateViewState extends State<SsqStateView>
  ...
  List<CensusCell> cells = [
    CensusCell(title: '开奖号码', width: 130.w, height: trendCellSize),
    CensusCell(title: '和值', width: 38.w, height: trendCellSize),
    CensusCell(title: '跨度', width: 38.w, height: trendCellSize),
    CensusCell(title: '大小形态', width: 110.w, height: trendCellSize),
    CensusCell(title: '大小比', width: 66.w, height: trendCellSize),
    CensusCell(title: '奇偶形态', width: 110.w, height: trendCellSize),
    CensusCell(title: '奇偶比', width: 66.w, height: trendCellSize),
    CensusCell(title: '质合形态', width: 110.w, height: trendCellSize),
