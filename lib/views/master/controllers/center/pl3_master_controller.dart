...
class Pl3MasterController extends AbsPageQueryController {
  ///
  ///方案更新专家信息
  ...
  ///
  List<TabEntry> dropEntries = pl3Channels.entries
  ...
  List<Future<void>> getRequestFutures() {
    Future<void> renewMasterAsync = LottoMasterRepository.pl3RenewMaster()
        .then((value) => renewMasters = value);
    Future<void> recentBrowseAsync = UserInfoRepository.recentBrowse('pl3')
        .then((value) => browseRecord = value);
    Future<void> schemaAsync =
        LottoMasterRepository.pl3SchemaMasters().then((value) => schemas
          ..clear()
          ..addAll(value));
    Future<void> rankAsync =
        MasterRankRepository.mulPl3MasterRanks(page: 1, limit: 5)
            .then((value) => ranks
              ..clear()
              ..addAll(value.records));
    Future<void> homeAsync =
        LottoMasterRepository.homeMasters('pls').then((value) => homeMasters
          ..clear()
          ..addAll(value));
    return [
      renewMasterAsync,
