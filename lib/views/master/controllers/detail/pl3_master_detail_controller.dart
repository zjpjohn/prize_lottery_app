...
class Pl3MasterDetailController extends AbsRequestController {
  ///
  ///专家标识
  late String masterId;

  ///专家详情
  late Pl3MasterDetail master;
  ...
  ///
  /// 推荐专家信息
  List<Pl3MasterMulRank> masters = [];

  ///历史预测成绩
  List<Pl3History> histories = [];
  ...
  void showRecommendMasters(Function() callback) {
    ...
    update();
    MasterRankRepository.mulPl3MasterRanks(page: 1, limit: 7).then((value) {
  ...
  void calcHistory(List<Pl3History> datas) {
  ...
  Future<void> request() async {
    ...
    ///
    Future<void> masterAsync = LottoMasterRepository.pl3MasterDetail(masterId)
        .then((value) => master = value);

    ///
    Future<void> historyAsync =
        ForecastInfoRepository.pl3Histories(masterId).then((value) {
      histories
        ..clear()
        ..addAll(value);
