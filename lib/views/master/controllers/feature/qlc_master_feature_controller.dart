...
class QlcMasterFeatureController extends AbsRequestController {
  ///
  ///
  late String masterId;

  ///
  late QlcMasterRate rate;

  ///
  List<QlcICaiHit> hits = [];
  ...
  Future<void> request() async {
    ...
    Future<void> rateAsync =
        MasterFeatureRepository.qlcMasterRate(masterId).then((value) {
      rate = value;
    });
    Future<void> hitAsync =
        MasterFeatureRepository.qlcMasterHits(masterId).then((value) {
      hits = value;
    });
