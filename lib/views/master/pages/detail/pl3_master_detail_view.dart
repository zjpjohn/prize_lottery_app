...
import 'package:prize_lottery_app/views/master/controllers/detail/pl3_master_detail_controller.dart';
...
class Pl3MasterDetailView extends StatefulWidget {
  const Pl3MasterDetailView({super.key});

  @override
  State<Pl3MasterDetailView> createState() => _Pl3MasterDetailViewState();
}

class _Pl3MasterDetailViewState extends State<Pl3MasterDetailView> {
  ///
  ///
  ...
  Widget build(BuildContext context) {
    return AnnotatedRegion(
      ...
      child: Scaffold(
        ...
        body: SafeArea(
          top: true,
          child: RequestWidget<Pl3MasterDetailController>(
            global: false,
            duration: 50,
            init: Pl3MasterDetailController(),
            builder: (controller) {
                  ...
                  return [
                    SliverPersistentHeader(
                      ...
                      delegate: MasterHeader(
                        ...
                        onTap: () {
                          Get.toNamed(
                            '/pl3/master/feature/${controller.master.master.masterId}',
                          );
                        },
                      ),
                    ),
  ...
  Widget buildMasterView(Pl3MasterDetailController controller) {
    Pl3MasterDetail detail = controller.master;
    return SizedBox(
      width: Get.width,
      child: Column(
            ...
            child: Row(
              children: [
                ...
                Expanded(
                  child: GestureDetector(
                    onTap: () {
                      Get.toNamed('/pl3/forecast/${detail.master.masterId}');
                    },
                    child: Container(
                      height: 32.w,
                      alignment: Alignment.center,
  ...
  List<String> getSkillTxt(Pl3MasterDetail detail) {
    List<String> txt = [];
  ...
  Widget _buildRecommendMasters(Pl3MasterDetailController controller) {
    return Container(
      margin: EdgeInsets.only(bottom: 24.w, top: 8.w),
      child: Column(
        crossAxisAlignment: CrossAxisAlignment.start,
        children: [
          Padding(
              ...
              child: Row(
                children: [
                  ...
                  ...controller.masters.map(
                    (e) => GestureDetector(
                      onTap: () {
                        Get.toNamed('/pl3/master/${e.master.masterId}');
                      },
                      behavior: HitTestBehavior.opaque,
                      child: Container(
                        padding: EdgeInsets.all(0.3.w),
                        margin: EdgeInsets.only(right: 16.w, bottom: 2.w),
                        decoration: BoxDecoration(
