...
class Pl3PivotView extends StatefulWidget {
  const Pl3PivotView({super.key});

  @override
  State<Pl3PivotView> createState() => _Pl3PivotViewState();
}

class _Pl3PivotViewState extends State<Pl3PivotView> {
  ///
  ...
  Widget build(BuildContext context) {
    return LayoutContainer(
      ...
      content: RequestWidget<TodayPivotController>(
        init: TodayPivotController('pls'),
        builder: (controller) {
          return VisibilityDetector(
            key: const Key('pl3-pivot'),
        ...
        child: Column(
          ...
          children: [
            ...
            Padding(
              ...
              child: Text(
                '1.今日重点功能是系统对本期开奖数据给出首要关注、重点关注、优质号码优先级。'
