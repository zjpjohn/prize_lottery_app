...
class DltItemRankController extends AbsPageQueryController {
  ///
  late MasterRankRepository rankRepository;

  ///
  late MasterGladRepository gladRepository;
  ...
  set type(String type) {
    ...
    ///
    page = 1;
    MasterRankRepository.dltMasterRanks(
      type: _type,
      page: page,
      limit: limit,
    ).then((value) {
  ...
  Future<void> onInitial() async {
    ...
    ///
    Future<void> rankAsync = MasterRankRepository.dltMasterRanks(
      type: type,
      page: page,
      limit: limit,
    ).then((value) {
  ...
  Future<void> onLoadMore() async {
    ...
    ///
    await MasterRankRepository.dltMasterRanks(
      type: type,
      page: page,
      limit: limit,
    ).then((value) {
