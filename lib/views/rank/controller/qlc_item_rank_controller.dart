...
class QlcItemRankController extends AbsPageQueryController {
  ///
  ...
  set type(String type) {
    ...
    ///
    page = 1;
    MasterRankRepository.qlcMasterRanks(
      type: _type,
      page: page,
      limit: limit,
    ).then((value) {
  ...
  Future<void> onInitial() async {
    ...
    ///
    Future<void> rankAsync = MasterRankRepository.qlcMasterRanks(
      type: type,
      page: page,
      limit: limit,
    ).then((value) {
  ...
  Future<void> onLoadMore() async {
    ...
    ///
    await MasterRankRepository.qlcMasterRanks(
      type: type,
      page: page,
      limit: limit,
    ).then((value) {
