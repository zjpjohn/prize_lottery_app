...
class SsqItemRankController extends AbsPageQueryController {
  ///
  ...
  set type(String type) {
    ...
    ///
    page = 1;
    MasterRankRepository.ssqMasterRanks(
      type: _type,
      page: page,
      limit: limit,
    ).then((value) {
  ...
  Future<void> onInitial() async {
    ...
    ///
    Future<void> rankAsync = MasterRankRepository.ssqMasterRanks(
      type: type,
      page: page,
      limit: limit,
    ).then((value) {
    ...
    ///
    Future<void> gladAsync = MasterGladRepository.ssqGladList(
      limit: 6,
    ).then(
      (value) => glads
        ..clear()
    ...
    Future.wait([rankAsync, gladAsync]).then((value) {
  ...
  Future<void> onLoadMore() async {
    ...
    ///
    await MasterRankRepository.ssqMasterRanks(
      type: type,
      page: page,
      limit: limit,
    ).then((value) {
