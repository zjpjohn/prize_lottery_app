...
///
///
class Fc3dMasterRank extends MasterItemRank {
  StatHitValue? dan3;
  StatHitValue? com7;
  StatHitValue? kill1;

  Fc3dMasterRank.fromJson(Map<String, dynamic> json) : super.fromJson(json) {
    if (json['dan3'] != null) {
...
///
///
class Fc3dMasterMulRank extends MasterMulRank {
  late StatHitValue dan3;
  late StatHitValue com6;
  late StatHitValue com7;
  late StatHitValue kill1;

  Fc3dMasterMulRank.fromJson(Map<String, dynamic> json) : super.fromJson(json) {
    dan3 = StatHitValue.fromJson(json['dan3']);
