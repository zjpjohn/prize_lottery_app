...
class Fc3dItemRankView extends StatefulWidget {
  ///
  const Fc3dItemRankView({super.key});

  @override
  Fc3dItemRankViewState createState() => Fc3dItemRankViewState();
}

class Fc3dItemRankViewState extends State<Fc3dItemRankView>
  ...
  ///
  List<TabEntry> tabEntries = fc3dChannels.entries
  ...
  Widget build(BuildContext context) {
    return AnnotatedRegion(
      ...
      child: Scaffold(
        ...
        body: Stack(
          children: [
            RefreshWidget<Fc3dItemRankController>(
            ...
            StreamBuilder<bool>(
              ...
              builder: (context, snapshot) {
                ...
                return Container(
                  ...
                  child: GetBuilder<Fc3dItemRankController>(
                    builder: (controller) {
  ...
  Widget _buildRankContainer(Fc3dItemRankController controller) {
    return ListView.builder(
      ...
      itemBuilder: (context, index) {
        ...
        Fc3dMasterRank rank = controller.ranks[realIndex];
        return ItemRankEntryWidget(
          ...
          onTap: () {
            ...
            Get.toNamed(
              '/fc3d/master/${rank.master.masterId}',
  ...
  Widget _topRankMasterView(
    Fc3dItemRankController controller,
  ...
  List<Widget> _topRankMasters(List<Fc3dMasterRank> ranks) {
    List<Widget> views = [];
    for (int i = 0; i < ranks.length; i++) {
      views.add(ItemRankEntryWidget(
        ...
        onTap: () {
          String channel = tabEntries[_tabController.index].key;
          Get.toNamed(
            '/fc3d/master/${ranks[i].master.masterId}',
            parameters: {'channel': channel},
          );
        },
      ));
  ...
  Widget _headerBackground(List<Fc3dMasterGlad> glads) {
    return Stack(
      ...
      children: [
        CachedAvatar(
          ...
          url: ResourceStore().resource(R.fc3dItemRankBg),
        ),
        VerticalMarquee(
          height: 28.w,
  ...
  void initState() {
    ...
    _tabController.addListener(() {
      if (_tabController.index == _tabController.animation!.value) {
        Fc3dItemRankController controller = Get.find<Fc3dItemRankController>();
