...
class Pl3ItemRankView extends StatefulWidget {
  ///
  const Pl3ItemRankView({super.key});

  @override
  Pl3ItemRankViewState createState() => Pl3ItemRankViewState();
}

class Pl3ItemRankViewState extends State<Pl3ItemRankView>
  ...
  ///
  List<TabEntry> tabEntries = pl3Channels.entries
  ...
  Widget build(BuildContext context) {
    return AnnotatedRegion(
      ...
      child: Scaffold(
        ...
        body: Stack(
          children: [
            RefreshWidget<Pl3ItemRankController>(
            ...
            StreamBuilder<bool>(
              ...
              builder: (context, snapshot) {
                ...
                return Container(
                  ...
                  child: GetBuilder<Pl3ItemRankController>(
                    builder: (controller) {
  ...
  Widget _buildRankContainer(Pl3ItemRankController controller) {
    return ListView.builder(
      ...
      itemBuilder: (context, index) {
        ...
        Pl3MasterRank rank = controller.ranks[realIndex];
        return ItemRankEntryWidget(
          ...
          onTap: () {
            ...
            Get.toNamed(
              '/pl3/master/${rank.master.masterId}',
  ...
  Widget _topRankMasterView(
    Pl3ItemRankController controller,
  ...
  List<Widget> _topRankMasters(List<Pl3MasterRank> ranks) {
    List<Widget> views = [];
    for (int i = 0; i < ranks.length; i++) {
      views.add(ItemRankEntryWidget(
        ...
        onTap: () {
          String channel = tabEntries[_tabController.index].key;
          Get.toNamed(
            '/pl3/master/${ranks[i].master.masterId}',
            parameters: {'channel': channel},
          );
        },
      ));
  ...
  Widget _headerBackground(List<Pl3MasterGlad> glads) {
    return Stack(
      ...
      children: [
        CachedAvatar(
          ...
          url: ResourceStore().resource(R.pl3ItemRankBg),
        ),
        VerticalMarquee(
          height: 28.w,
  ...
  void initState() {
    ...
    _tabController.addListener(() {
      if (_tabController.index == _tabController.animation!.value) {
        Pl3ItemRankController controller = Get.find<Pl3ItemRankController>();
