...
class SsqItemRankView extends StatefulWidget {
  ///
  const SsqItemRankView({super.key});

  @override
  SsqItemRankViewState createState() => SsqItemRankViewState();
}

class SsqItemRankViewState extends State<SsqItemRankView>
  ...
  ///
  final List<TabEntry> tabEntries = ssqChannels.entries
  ...
  Widget build(BuildContext context) {
    return AnnotatedRegion(
      ...
      child: Scaffold(
        ...
        body: Stack(
          children: [
            RefreshWidget<SsqItemRankController>(
            ...
            StreamBuilder<bool>(
              ...
              builder: (context, snapshot) {
                ...
                return Container(
                  ...
                  child: GetBuilder<SsqItemRankController>(
                    builder: (controller) {
  ...
  Widget _topRankMasterView(
    SsqItemRankController controller,
    List<SsqMasterGlad> glads,
    List<SsqMasterRank> ranks,
  ) {
    return Stack(
      children: [
  ...
  List<Widget> _topRankMasters(List<SsqMasterRank> ranks) {
    List<Widget> views = [];
    for (int i = 0; i < ranks.length; i++) {
      views.add(ItemRankEntryWidget(
        ...
        onTap: () {
          ...
          Get.toNamed(
            '/ssq/master/${ranks[i].master.masterId}',
  ...
  Widget _buildRankContainer(SsqItemRankController controller) {
    return ListView.builder(
      ...
      itemBuilder: (context, index) {
        ...
        SsqMasterRank rank = controller.ranks[realIndex];
  ...
  Widget _headerBackground(List<SsqMasterGlad> glads) {
    return Stack(
      ...
      children: [
        CachedAvatar(
          ...
          url: ResourceStore().resource(R.ssqItemRankBg),
        ),
        VerticalMarquee(
          height: 28.w,
  ...
  void initState() {
    ...
    _tabController.addListener(() {
      if (_tabController.index == _tabController.animation!.value) {
        SsqItemRankController controller = Get.find<SsqItemRankController>();
