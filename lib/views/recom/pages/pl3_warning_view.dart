...
class Pl3WarningView extends StatelessWidget {
  ///
  ///
  const Pl3WarningView({super.key});
  ...
  Widget build(BuildContext context) {
    return LayoutContainer(
      ...
      content: RequestWidget<Pl3WarningController>(
        emptyText: '暂无预警推荐内容',
        builder: (controller) {
          return Stack(
            children: [
  ...
  Widget _buildPeriodView(Pl3WarningController controller) {
    return Container(
      width: 34.w,
      decoration: BoxDecoration(
        color: Colors.white,
  ...
  Widget _buildWarnHeader(Pl3WarningController controller) {
    return Container(
  ...
  Widget _buildLastAnalyze(Pl3WarningController controller) {
    return Container(
  ...
  Widget _buildWarnContent(Pl3WarningController controller) {
    return Container(
      padding: EdgeInsets.only(
        left: 16.w,
        right: 16.w,
  ...
  Widget _buildAuthedContent(Pl3WarningController controller) {
    return Column(
      crossAxisAlignment: CrossAxisAlignment.start,
      children: [
  ...
  Widget _buildUnAuthedContent(Pl3WarningController controller) {
