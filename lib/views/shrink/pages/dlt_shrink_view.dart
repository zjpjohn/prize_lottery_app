...
class DltShrinkView extends StatelessWidget {
  ///
  ///
  const DltShrinkView({super.key});
  ...
  Widget build(BuildContext context) {
    return LayoutContainer(
      title: '缩水过滤',
      border: false,
      content: RequestWidget<DltShrinkController>(
        builder: (controller) {
  ...
  Widget _buildDanBall(DltShrinkController controller) {
    return Stack(
      children: [
        Container(
          ...
          child: Column(
            ...
            children: [
              Wrap(
                children: dlt.map((item) => _ball(item, controller)).toList(),
              ),
              Padding(
  ...
  Widget _ball(int ball, DltShrinkController controller) {
    return Container(
  ...
  Widget _buildShrinkPanel(DltShrinkController controller) {
    return Stack(
      children: [
        Container(
          padding:
              EdgeInsets.only(top: 30.w, left: 16.w, right: 16.w, bottom: 24.w),
          child: Column(
            children: [
              Padding(
                    ...
                    ClipButton(
                      ...
                      onTap: (value) {
                        Constants.bottomSheet(
                          GetBuilder<DltShrinkController>(
                              builder: (controller) {
  ...
  Widget _buildShrinkResult(DltShrinkController controller) {
