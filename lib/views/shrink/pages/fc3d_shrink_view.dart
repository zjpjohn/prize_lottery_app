...
class Fc3dShrinkView extends StatelessWidget {
  ///
  ///
  const Fc3dShrinkView({super.key});
  ...
  Widget build(BuildContext context) {
    return LayoutContainer(
      title: '缩水过滤',
      border: false,
      content: RequestWidget<Fc3dShrinkController>(
        builder: (controller) {
  ...
  Widget _buildBallView(Fc3dShrinkController controller) {
    return Stack(
      children: [
        Column(
  ...
  Widget _buildShrinkPanel(Fc3dShrinkController controller) {
    return Container(
      color: Colors.white,
      child: Stack(
        children: [
                      ...
                      ClipButton(
                        ...
                        onTap: (value) {
                          Constants.bottomSheet(
                            GetBuilder<Fc3dShrinkController>(
                                builder: (controller) {
  ...
  Widget _buildShrinkResult(Fc3dShrinkController controller) {
    List<List<int>> balls =
  ...
  Widget _buildShrinkType(Fc3dShrinkController controller) {
    return Container(
  ...
  Widget _buildDirectView(Fc3dShrinkController controller) {
    return Container(
  ...
  Widget _ballD(int index, int value, Fc3dShrinkController controller) {
    return Container(
  ...
  Widget _buildDirectItem(
      String name, int index, Fc3dShrinkController controller) {
    return Row(
  ...
  Widget _ballC(int value, Fc3dShrinkController controller) {
    return Container(
      margin: EdgeInsets.only(right: 8.w),
      child: GestureDetector(
        onTap: () {
  ...
  Widget _buildCombineView(Fc3dShrinkController controller) {
    return Container(
      margin: EdgeInsets.fromLTRB(16.w, 12.w, 0, 12.w),
      child: Column(
        crossAxisAlignment: CrossAxisAlignment.start,
