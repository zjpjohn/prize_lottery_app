...
class SsqShrinkView extends StatelessWidget {
  ///
  ///
  const SsqShrinkView({super.key});
  ...
  Widget build(BuildContext context) {
    return LayoutContainer(
      title: '缩水过滤',
      border: false,
      content: RequestWidget<SsqShrinkController>(
        builder: (controller) {
  ...
  Widget _buildDanBall(SsqShrinkController controller) {
    return Stack(
      children: [
        Container(
          ...
          child: Column(
            ...
            children: [
              Wrap(
                children: ssq.map((item) => _ball(item, controller)).toList(),
              ),
              Padding(
  ...
  Widget _ball(int ball, SsqShrinkController controller) {
    return Container(
  ...
  Widget _buildShrinkPanel(SsqShrinkController controller) {
    return Stack(
      children: [
        Container(
          padding: EdgeInsets.only(
                    ...
                    ClipButton(
                      ...
                      onTap: (value) {
                        Constants.bottomSheet(
                          GetBuilder<SsqShrinkController>(
                              builder: (controller) {
  ...
  Widget _buildShrinkResult(SsqShrinkController controller) {
